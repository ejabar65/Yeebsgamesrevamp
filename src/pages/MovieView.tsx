  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#020202] gap-12">
        ...
        <p className="text-[12px] font-black uppercase tracking-[0.5em] text-gray-800 animate-pulse">Loading Player...</p>
      </div>
    );
  }
  ...
  if (!media) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-[#020202] text-center p-6">
        ...
        <h1 className="text-4xl font-black text-white uppercase italic tracking-tighter mb-4">Not Found</h1>
        <p className="text-[10px] uppercase font-black tracking-widest text-gray-700 mb-12">The content you're looking for is unavailable.</p>
        <button 
